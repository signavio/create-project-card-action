...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const isDraft = (_a = github_1.context.payload.pull_request) === null || _a === void 0 ? void 0 : _a.isDraft;
            const owner = github_1.context.repo.owner;
            const repo = github_1.context.repo.repo;
            const pr_number = Number((_b = github_1.context.payload.pull_request) === null || _b === void 0 ? void 0 : _b.number);
            ...
            const prId = (_c = github_1.context.payload.pull_request) === null || _c === void 0 ? void 0 : _c.id;
            if (ignoreDrafts) {
                if (!isDraft) {
